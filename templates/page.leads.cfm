					...
					<div class="container">						
						...
						<div class="row">
							...
							<div class="span8">
								...
								<div class="faq-container">
									...
									<div class="faq-toc">
										<ol>
											<li>1. <a href="#faq-1">How can I get my own domain name?</a></li>
											<li>2. <a href="#faq-2">How can I block my hosting service's advertisements?</a></li>
											<li>3. <a href="#faq-3">How do I redirect someone to another page?</a></li>
											<li>4. <a href="#faq-4">How do I password protect my web site?</a></li>
											<li>5. <a href="#faq-5">How do I stop my page from being cached?</a></li>
											<li>6. <a href="#faq-6">How can I disable the browser's right-click options?</a></li>
											...
											<li>10. <a href="#faq-10">Why is my custom 404 Not Found message not displayed?</a></li>
										</ol>
									</div>
						...
						These scripts do nothing when JavaScript is disabled or unavailable, when JavaScript access to right-click events is disabled, on systems without mice, or on systems with single-button mice.</p>	
								...
								<div class="span4">
									...
									<a href="javascript:;" class="btn btn-large btn-primary btn-block btn-big-block">Create New Inquiry</a>	
								
								
									<a href="javascript:;" class="btn btn-large btn-tertiary btn-block btn-big-block">Internet Leads</a>
